...
import com.daoyintech.daoyin_release.service.UserIntegralDetailService;
...
public class UserIntegralDetailServiceImpl implements UserIntegralDetailService{
    ...
    public List<UserIntegralDetail> findByUserIdAndType(User user, int page, int type) {
        ...
        return userIntegralDetailRepository.findByUserIdAndUserIntegralFromTypeOrderByCreatedAtDesc(user.getId(),integralFromType, new PageRequest(page, pageSize));
    }
